...
def get_task_templates(model_name):
    if model_name.lower() == 'pod':
        col_seps = {
            U_HIST_I_COL: ' item_',
            f'{I_COL}_pool': ' item_'
        }
        return col_seps, {
            Task.NEXT_ITEM: [(t, [U_COL, U_HIST_I_COL], I_COL) for t in [
            ...
            Task.EXPLANATION: [(t, [U_COL, I_COL], EXP_COL) for t in [
            ...
            Task.TOPN: [(t, [U_COL, f'{I_COL}_pool'], I_COL) for t in [
